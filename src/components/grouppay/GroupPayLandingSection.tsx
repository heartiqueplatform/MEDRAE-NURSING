...
// ============================================================
// GROUP PAY LANDING SECTION
// Always GitHub-dark. Flat colors only — no gradients.
// ============================================================
...
const IND_1MO = 249;
const IND_2MO = 399;
const SAVE_1MO = IND_1MO - GROUP_1MO;
const SAVE_2MO = IND_2MO - GROUP_2MO;
...
const GroupPayLandingSection = () => {
    const features = [
        ...
        },
        {
            ...
            description: "Form a group with classmates, share resources, and keep each other on track for exams.",
            color: GH.blue,
            bg: GH.blueBg,
            saving: null,
        },
        {
            ...
            description: "When the group pays, every member unlocks premium instantly — no individual payments, no waiting.",
            color: GH.yellow,
            bg: GH.yellowBg,
            saving: null,
        },
        {
            ...
            description: "The leader pays once via M-Pesa. Everyone else's account upgrades automatically within seconds.",
            color: GH.purple,
            bg: GH.purpleBg,
            saving: null,
        },
        {
            ...
            description: "Connect with students from other schools, share notes, and build your professional network early.",
            color: GH.blue,
            bg: GH.blueBg,
            saving: null,
        },
        {
            icon: Target,
            title: "Study Smarter",
            description: "Group learning beats solo. Cover more ground, stay motivated, and walk into exams prepared.",
            color: GH.red,
            bg: GH.redBg,
            saving: null,
        },
    ...
    const benefits = [
        { icon: DollarSign, title: "Budget-Friendly", description: `From ${CURRENCY} ${GROUP_1MO} per member` },
        { icon: BookOpen, title: "Full Premium Access", description: "Every feature, unlocked" },
        { icon: Users, title: "Learn Together", description: "Study with your classmates, not alone" },
        { icon: Sparkles, title: "Instant Activation", description: "Access unlocks the moment you pay" },
    ];
